...
class Game
  attr_accessor :chosen_word, :total_lives, :right_letters, :wrong_letters, :current_lives, :turn_counter, :end_game_flag
  ...
  def initialize(chosen_word = '', total_lives = MAX_LIFE, right_letters = [''], wrong_letters = [], current_lives = MAX_LIFE, turn_counter = 0)
    if chosen_word == ''
